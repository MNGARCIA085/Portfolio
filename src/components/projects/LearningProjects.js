...
function LearningProjects() {
  ...
  useEffect(() => {
    fetch('/data_learning_projects.json')
  ...
  return (
    <div className="container">
      <h2 className="my-4"><font color='#2874a6'><center>Learning Projects</center></font></h2>
      <hr />
      <br />
        ...
        {currentItems.map((item, index) => {
          ...
          return (
            <div key={index} className="col-sm-6 col-md-4 col-lg-3">
              <div 
                className="card mb-4" 
                onClick={() => navigate(`/projects/learning/${item.name_page}`)} 
